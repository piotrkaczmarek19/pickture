...
class Image
{
    ...
    */
     ...
     * Set imWidth
     *
     * @param integer $imWidth
     *
     * @return Image
     */
    public function setImWidth($imWidth)
    {
        $this->im_width = $imWidth;
     ...
     * Set imHeight
     *
     * @param integer $imHeight
     *
     * @return Image
     */
    public function setImHeight($imHeight)
    {
        $this->im_height = $imHeight;
